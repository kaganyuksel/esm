<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="ESM.BancoProyectos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <![endif]-->
    <div id='magazine'>
        <div class="page_magazine" id="portada">
        ...
        <div class="page_magazine" id="basicaproyecto">
            ...
            <div class="h3">
                <h3>
                    * Nombre de Proyecto:</h3>
            </div>
            <div class="row">
                <textarea id="txtnombreproyecto" runat="server" cols="20" rows="50"></textarea>
            </div>
            <div class="h3">
                <h3>
                    * Propósito:</h3>
            ...
            <div class="row">
                <textarea id="txtproposito" runat="server" cols="20" rows="50"></textarea>
            </div>
            <div class="h3">
                <h3>
                    * Finalidad:</h3>
            ...
            <div class="row">
                <textarea id="txtfinalidad" runat="server" cols="20" rows="50"></textarea>
            </div>
            <div class="h3">
                <h3>
                    * Problema Central</h3>
            ...
            <div class="row">
                <textarea cols="20" rows="50" id="txtproblema" runat="server"> </textarea>
            </div>
            <div class="row">
                <asp:Button CssClass="button-success" Text="Almacenar Proyecto" ID="btnalmacenarproyecto"
                    runat="server" OnClick="btnalmacenarproyecto_Click" />
            </div>
            <div class="h3">
                <h3>
            ...
            <div class="row">
                <textarea id="txtdependencia" runat="server" name="name"></textarea>
            </div>
            <div class="h3">
                <h3>
            ...
            <div class="row">
                <textarea id="txtresponsable" runat="server"></textarea>
            </div>
            <div class="h3">
                <h3>
                    Cargo:
            ...
            <div class="row">
                <textarea runat="server" id="txtcargo"></textarea>
            </div>
            <div class="h3">
                <h3>
            ...
            <div class="row">
                <input type="text" id="txtfechaelaboracion" runat="server" value=" " />
            </div>
            <div class="h3">
                <h3>
            ...
            <div class="h3">
                <h3>
                    Estrategia o programa del Plan Nacional de Desarrollo con la que se relaciona el
                    proyecto</h3>
            </div>
            <div class="row">
                <textarea id="txtmpp1" runat="server"></textarea>
            </div>
            <div class="h3">
                <h3>
                    Estrategia o programa del Plan Sectorial de Educación con la que se relaciona el
                    proyecto</h3>
            </div>
            <div class="row">
                <textarea id="txtmpp2" runat="server"></textarea>
            </div>
            <div class="h3">
                <h3>
                    Objetivo Misional de la Subdirección con el que se relaciona el proyecto</h3>
            </div>
            <div class="row">
                <textarea id="txtmpp3" runat="server"></textarea>
            </div>
            <div class="h3">
                <h3>
                    *Justifique brevemente la necesidad del proyecto:</h3>
            </div>
            <div class="row">
                <textarea id="txtjustificacion" runat="server"></textarea>
            </div>
            <div class="row">
    ...
    ID="btnuploadfile" OnClick="btnuploadfile_Click" /> <div id="dialog_proyectos" style="dysplay:
    none;"> </div> <div class="qtip qtip-stylename"> <div class="qtip-tip" rel="cornerValue">
    </div> <div class="qtip-wrapper"> <div class="qtip-borderTop"> </div> <div class="qtip-contentWrapper">
    <div class="qtip-title"> <div class="qtip-button"> </div> </div> <div class="qtip-content">
    </div> </div> <div class="qtip-borderBottom"> </div> </div> </div>
</asp:Content>
