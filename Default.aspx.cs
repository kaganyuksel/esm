...
namespace ESM
{
    public partial class BancoProyectos : System.Web.UI.Page
    {
        ...
        protected string generateArbolObjetivosWeb()
        {
            ...
            string finalidadUpper = "";

            if (proyecto.Finalidad != null)
                finalidadUpper = proyecto.Finalidad.ToUpper();

            html_arbol_objetivos += "<td style='height:100px; text-align:center; vertical-align: middle; background: #258A0C; color: #fff; border: dashed #000 2px;' colspan='" + colspan_proyecto.ToString() + "'><b>" + finalidadUpper + "</b></td>";
            ...
            string propositoUpper = "";

            if (proyecto.Proposito != null)
                propositoUpper = proyecto.Proposito.ToUpper();

            html_arbol_objetivos += "</tr><tr><td style='height:100px; text-align:center; vertical-align: middle; border: dashed #000 2px;' colspan='" + colspan_proyecto.ToString() + "'>" + propositoUpper + "</td></tr><tr style='height: 20px;'>";
        ...
        protected void generateFuentesFinanciacion()
        {
            ...
            string fuentes_financiacion = "<table cellspacing='0' style='width:100%; border: 1px solid #000;'><theader><tr><th class='th' style='border: 1px solid #000;'>TIPO ENTIDAD</th><th class='th' style='border: 1px solid #000;'>ENTIDAD</th><th class='th' style='border: 1px solid #000;'>TIPO RECURSO</th></tr></theader><tbody>";
