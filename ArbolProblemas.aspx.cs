                    ...
                    foreach (var item_subroceso in objSubprocesos)
                    {
                        ...
                        foreach (var item_estrategias in objEstrategias)
                        {
                            ...
                            foreach (var item_actividades in objActividades)
                            {
                                ...
                                objsb_actividades.Append("<td> <textarea id='txt_area_actividades_up_" + item_actividades.Id + "' placeholder='Texto correspondiente a actividades'>" + item_actividades.Actividad + "</textarea><br/>Presupuesto<br/><input type='text' placeholder='Campo exclusivamente numerico' class='numerico' style='width:80%;' value=" + item_actividades.Presupuesto + "  id='txt_actividad_presupuesto_up" + item_estrategias.Id + "' Fecha <br/><input type='text' placeholder='Campo exclusivamente numerico' class='numerico datepiker' style='width:80%;' value=" + item_actividades.fecha + "  id='txt_actividad_presupuesto_up" + item_estrategias.Id + "'> <br/>");
